function median(array) {
  return array.length % 2 == 0 ? array.sort((a,b)=>a-b).slice(array.length/2-1,array.length/2+1).reduce((a,b)=>a+b)/2 :
                                 parseInt(array.sort((c,d)=>c-d).slice(array.length/2,(array.length/2)+1))
}
// Description:
