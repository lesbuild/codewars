function checkDigit(number, index1, index2, digit) {
  return index1 > index2 ? number.toString().substring(index2,index1+1).includes(digit.toString()) :
                           number.toString().substring(index1,index2+1).includes(digit.toString())
};
// Description:
