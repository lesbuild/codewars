function battleOfSides(num){
    num = num.toString();
    let left = num.substring(0,Math.ceil(num.length/2)).split("").reduce((a,b)=>parseInt(a)+parseInt(b),0)
    let right = num.substring(Math.floor(num.length/2)).split("").reduce((a,b)=>parseInt(a)+parseInt(b),0)
